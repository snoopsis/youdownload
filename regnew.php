		...
		<header id="header" class="full-header transparent-header border-full-header dark static-sticky" data-sticky-class="not-dark" data-sticky-offset="full" data-sticky-offset-negative="100">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo"><img src="one-page/images/canvasone.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
						...
						<div class="offset-lg-7 col-lg-5 full-screen" style="background-color: rgba(0,0,0,0.45);">
							<div class="vertical-middle col-padding">
								<div class="heading-block nobottomborder bottommargin-sm">
									<h1 style="font-size: 22px;">Registar uma Conta</h1>
									<span style="font-size: 16px;" class="t300 capitalize ls1 notopmargin">cadastro rapido para guardar seus videos e musicas temporariamente para download.</span>
								</div>
								<form action="" class="clearfix" id="register-form" name="register-form" style="max-width: 300px;" method="post">
									<div class="col_full">
										<label for="register-form-name" class="capitalize t600">Nome</label>
										<input type="text" id="name" name="name" value="" class="form-control not-dark"/>										
									</div>
									
									<div class="col_full">
										<label for="register-form-email" class="capitalize t600">E-mail</label>
									...
									<div class="col_full <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
										<label for="register-form-username" class="capitalize t600">Usuario</label>
										<input type="text" id="username" name="username" value="" class="form-control not-dark" />
										<span class="help-block"><?php echo $username_err; ?></span>
									</div>
									
									<div class="col_full">
										<label for="register-form-password" class="capitalize t600">Escolha Senha</label>
										<input type="password" id="password" name="password" class="form-control not-dark" />
										<span class="help-block"><?php echo $password_err; ?></span>
									</div>
									
									<div class="col_full">
										<label for="register-form-repassword" class="capitalize t600">Confirme Senha</label>
										<input type="password" name="confirm_password" id="confirm_password" class="form-control not-dark" />
										<span class="help-block"><?php echo $confirm_password_err; ?></span>
									</div>
									
									<div class="col_full">
										<input type="submit" class="t400 capitalize button button-border button-light button-circle nomargin" value="Cadastrar Agora">
									</div>
								</form>
								
								<div class="col_full">
										<a href="index.php" class="t400 capitalize button button-border button-light button-circle nomargin">Voltar</a>
									</div>
