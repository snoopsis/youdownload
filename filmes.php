...
<?php $result = shell_exec("ls /var/www/html/remote/filmes/*.mp4"); ?>
<?php							
...
if ( !empty($lines) ) {
  ...
  <!-- SLIDE  -->
						   <li data-index="<?php echo trim($line, '/var/www/html/remote/filmes/'); ?>" data-transition="fade" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb=""  data-rotate="0"  data-saveperformance="off"  data-title="<?php echo trim($line, '/var/www/html/remote/filmes/'); ?>" data-param1="Filmes Lancamento" data-description="">
							<!-- MAIN IMAGE -->
